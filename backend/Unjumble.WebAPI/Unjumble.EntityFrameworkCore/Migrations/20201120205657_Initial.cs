        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Companies_AspNetUsers_UserOwnerId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<string>(nullable: false),
                    ComapnyId = table.Column<string>(nullable: false),
                    IsAproved = table.Column<bool>(nullable: false),
                    RequestDate = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserCompanies", x => new { x.ComapnyId, x.UserId });
                    table.ForeignKey(
                        name: "FK_UserCompanies_Companies_ComapnyId",
