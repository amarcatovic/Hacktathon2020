...
namespace Unjumble.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20201121022919_AddCalendarEventEntity2")]
    partial class AddCalendarEventEntity2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Unjumble.Core.Models.Domain.CalendarEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Unjumble.Core.Models.Domain.IssueBase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("IssueBases");
                });

            modelBuilder.Entity("Unjumble.Core.Models.Domain.IssueBaseComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IssueBaseId");

                    b.HasIndex("UserId");

                    b.ToTable("IssueBaseComments");
                });
            ...
            modelBuilder.Entity("Unjumble.Core.Models.Domain.IssueBaseComment", b =>
                {
                    b.HasOne("Unjumble.Core.Models.Domain.Company", null)
                        .WithMany("IssueBaseComments")
                        .HasForeignKey("CompanyId");

                    b.HasOne("Unjumble.Core.Models.Domain.IssueBase", "IssueBase")
                        .WithMany("issueBaseComments")
                        .HasForeignKey("IssueBaseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
